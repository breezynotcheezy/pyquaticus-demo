...
if __name__ == '__main__':
    ...
    #Falls back to using CPU if GPU not availble. Essential.
    ...
    ppo_config.update_from_dict({ #Optimized training parameters specific to GTX 1070. May need changing if not using same GPU
